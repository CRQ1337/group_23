...
Таблица пользователей базы данных qa_students_1 - https://docs.google.com/spreadsheets/d/1cQB_JxdkrXqEMmb8fFIebDpgzNOZkm8lTcyCnLIhpDU/edit?usp=sharing
...
SELECT COUNT(id) FROM public.students;
 ...
 31. Вывести id пользователя, имя, дату создания пользователя. Отсортировать по порядку возрастания даты добавления 
пользоватлеля.
SELECT id, name, created_on
FROM public.students
ORDER BY created_on ASC;

 32. Вывести id пользователя, имя, дату создания пользователя. Отсортировать по порядку убывания даты добавления 
пользоватлеля.
SELECT id, name, created_on
FROM public.students
